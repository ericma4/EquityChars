...
if __name__ == "__main__":
    ...
    if not username or not password:
        print("WRDS credentials not found in environment variables.")
        print("Please set WRDS_USERNAME and WRDS_PASSWORD, or enter them below:")
